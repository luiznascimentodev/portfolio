...
export default async function BlogPage({ searchParams }: BlogPageProps) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-white via-gray-50 to-white dark:from-black dark:via-gray-950 dark:to-black">
      ...
      {/* Admin login link — discreto no rodapé */}
      <div className="pb-8 flex justify-center">
        <Link
          href="/login"
          className="inline-flex items-center gap-1.5 text-xs text-gray-300 dark:text-gray-700 hover:text-primary dark:hover:text-primary transition-colors duration-200"
